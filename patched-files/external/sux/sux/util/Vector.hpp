...
#define MADV_HUGEPAGE 0
  ...
  public:
    ...
    void copy_from_other(const Vector& other) {
        *this = Vector(other.data,other._size);
    }

	// Define copy operators
	Vector(const Vector &other) {copy_from_other(other);}
	Vector &operator=(const Vector &other) {copy_from_other(other);return *this;}
	...
	uint64_t size_in_bytes() const {
		return sizeof(this)+_capacity*sizeof(T);
	}
