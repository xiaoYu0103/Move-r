...
template <util::AllocType AT = util::AllocType::MALLOC> class SimpleSelect : public Select {
  ...
  public:
    ...
    SimpleSelect(SimpleSelect&& other) = default;
    SimpleSelect(const SimpleSelect& other) = default;
    SimpleSelect& operator=(SimpleSelect&& other) = default;
    SimpleSelect& operator=(const SimpleSelect& other) = default;
	...
	void serialize(std::ostream& out) const {
        out << inventory;
        out << exact_spill;
		out.write((char*)&log2_ones_per_inventory,sizeof(int));
		out.write((char*)&log2_ones_per_sub16,sizeof(int));
		out.write((char*)&log2_ones_per_sub64,sizeof(int));
		out.write((char*)&log2_longwords_per_subinventory,sizeof(int));
		out.write((char*)&ones_per_inventory,sizeof(int));
		out.write((char*)&ones_per_sub16,sizeof(int));
		out.write((char*)&ones_per_sub64,sizeof(int));
		out.write((char*)&longwords_per_subinventory,sizeof(int));
		out.write((char*)&longwords_per_inventory,sizeof(int));
		out.write((char*)&ones_per_inventory_mask,sizeof(int));
		out.write((char*)&ones_per_sub16_mask,sizeof(int));
		out.write((char*)&ones_per_sub64_mask,sizeof(int));
		...
		out.write((char*)&num_ones,sizeof(uint64_t));
    }
	
    void load(std::istream& in) {
        in >> inventory;
        in >> exact_spill;
		in.read((char*)&log2_ones_per_inventory,sizeof(int));
		in.read((char*)&log2_ones_per_sub16,sizeof(int));
		in.read((char*)&log2_ones_per_sub64,sizeof(int));
		in.read((char*)&log2_longwords_per_subinventory,sizeof(int));
		in.read((char*)&ones_per_inventory,sizeof(int));
		in.read((char*)&ones_per_sub16,sizeof(int));
		in.read((char*)&ones_per_sub64,sizeof(int));
		in.read((char*)&longwords_per_subinventory,sizeof(int));
		in.read((char*)&longwords_per_inventory,sizeof(int));
		in.read((char*)&ones_per_inventory_mask,sizeof(int));
		in.read((char*)&ones_per_sub16_mask,sizeof(int));
		in.read((char*)&ones_per_sub64_mask,sizeof(int));
		...
		in.read((char*)&num_ones,sizeof(uint64_t));
    }
