...
template< class bv_t = bit_vector,
          template<class> class char_map_t = symbol_map >
class heads_bv_w
{
private:
    ...
    struct rank_select_bv {
        ...
        void copy_from_other(const rank_select_bv& other) {
            bv = other.rank;
            set_rs();
        }

        void move_from_other(rank_select_bv&& other) {
            other.reset_rs();
        ...
        void set_rs() {
            rank.set_vector(&bv);
            select.set_vector(&bv);
        }

        void reset_rs() {
            rank.set_vector(NULL);
            select.set_vector(NULL);
        }

        rank_select_bv() {}

        rank_select_bv(rank_select_bv&& other) {move_from_other(std::move(other));}
        rank_select_bv(const rank_select_bv& other) {copy_from_other(other);}
        rank_select_bv& operator=(rank_select_bv&& other) {move_from_other(std::move(other));return *this;}
        rank_select_bv& operator=(const rank_select_bv& other) {copy_from_other(other);return *this;}
