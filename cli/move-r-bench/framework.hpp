...
query_result locate_patterns(idx_t& index, std::ifstream& patterns_file)
{
    ...
    if (check_correctness) {
        if (correct)
            std::cout << " (no wrong occurrences)";
        else
            std::cout << " (wrong occurrences)";
    }
...
void bench_index(std::string index_name, std::string index_log_name)
{
    ...
    std::cout << "index size: " << format_size(result_build.size_index) << std::endl
              << std::endl;
    ...
    if constexpr (bench_count) {
        ...
        std::cout << std::endl
                  << "total number of occurrences: " << result_count.num_occurrences << std::endl;
    ...
    if constexpr (bench_locate) {
        ...
        std::cout << std::endl
                  << "total number of occurrences: " << result_locate_1.num_occurrences << std::endl;
        ...
        std::cout << std::endl
                  << "total number of occurrences: " << result_locate_2.num_occurrences << std::endl;
    }

    if constexpr (bench_count || bench_locate)
        std::cout << std::endl;
...
{
    std::cout << std::endl
              << "building the suffix array" << std::flush;
    ...
    for (uint16_t a = 2; a <= 8192; a *= 2) {
        ...
        std::cout << std::endl
                  << "building move_r using " << format_threads(max_num_threads) << std::flush;
        ...
        std::cout << std::endl
                  << "counting the first set of patterns" << std::flush;
        result_count = count_patterns<pos_t>(index);
        std::cout << ": " << format_query_throughput(result_count.num_queries, result_count.time_query);
        std::cout << std::endl
                  << "total number of occurrences: " << result_count.num_occurrences << std::endl;
